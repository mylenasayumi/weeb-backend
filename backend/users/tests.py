...
class UserAPITests(APITestCase):
    ...
    def test_jwt_login_and_me(self):
        ...
        res = self.client.post(token_url, {"email": "john@example.com", "password": "pass12345"}, format="json")
    ...
    def test_partial_update_self(self):
        ...
        """
        token_url = reverse("token_obtain_pair")
        access = self.client.post(token_url, {"email": "john@example.com", "password": "pass12345"}).data["access"]
        self.client.credentials(HTTP_AUTHORIZATION=f"Bearer {access}")
